...
class TestVideoPlayer(unittest.TestCase):
    ...
    def test_frameskip(self):
        ...
        """
        player = utils.CPUVideoPlayer(self._video, frame_skip=120)
        for i, (ret, frame) in enumerate(player, start=1):
            self.assertTrue(ret and frame is not None)
    ...
    def test_start_position_int(self):
        ...
        """
        player = utils.CPUVideoPlayer(self._video, start=1800)
        for i, (ret, frame) in enumerate(player, start=1):
            self.assertTrue(ret and frame is not None)
    ...
    def test_stop_position_int(self):
        ...
        """
        player = utils.CPUVideoPlayer(self._video, finish=29)
        for i, (ret, frame) in enumerate(player, start=1):
            self.assertTrue(ret and frame is not None)
    ...
    def test_stop_position_final(self):
        ...
        """
        player = utils.CPUVideoPlayer(self._video, finish=2070)
        count = 0
    ...
    def test_start_stop(self):
        ...
        """
        player = utils.CPUVideoPlayer(self._video, start=2060, finish=2070)
        for i, (ret, frame) in enumerate(player, start=1):
            self.assertTrue(ret and frame is not None)
    ...
    def test_start_time(self):
        ...
        """
        player = utils.CPUVideoPlayer(self._video, start="00:00:15", finish="00:00:16")
        for i, (ret, frame) in enumerate(player, start=1):
            self.assertTrue(ret and frame is not None)
