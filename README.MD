...
section assumes you have copied these scripts into `mosaic-tutorial/examples`.
...
See if you can make the train tracks appear parallel. To exit, press ESC or close the window.
